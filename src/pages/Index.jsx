    ...
    <Box bg="gray.100" minH="100vh">
      ...
      <Container maxW="container.lg" py={8}>
        ...
        <VStack align="start" spacing={8}>
          ...
          <Text fontSize="lg">2 Academy Awards for Best Actor (Philadelphia, Forrest Gump), 4 Golden Globe Awards, 2 Screen Actors Guild Awards, Kennedy Center Honors (2014), Presidential Medal of Freedom (2016)</Text>
        </VStack>
      </Container>
    </Box>
  );
